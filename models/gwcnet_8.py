...
class feature_extraction(nn.Module):
    def __init__(self, concat_feature=False, concat_feature_channel=12):
        ...
        self.layer3 = self._make_layer(BasicBlock, 64, 16, 2, 1, 1)
        self.layer4 = self._make_layer(BasicBlock, 128, 3, 1, 1, 1)
        self.layer5 = self._make_layer(BasicBlock, 128, 3, 1, 1, 2)
    ...
    def forward(self, x):
        ...
        gwc_feature = torch.cat((l3, l4, l5), dim=1)
...
class Gwcnet_8(nn.Module):
    def __init__(self, maxdisp, use_concat_volume=False):
        super(Gwcnet_8, self).__init__()
    ...
    def forward(self, left, right):
        ...
        if self.training:
            ...
            pred4 = disparity_regression(pred4, self.maxdisp)
            #print("!!!!!!!!!")
