...
logger = SummaryWriter(comment='gwc-bts-refined')
...
def train():
    for epoch_idx in range(start_epoch, args.epochs):
        ...
        if (epoch_idx + 1) % args.save_freq == 0:
            ...
            torch.save(checkpoint_data, "{}/checkpoint_gwc_bts_{:0>6}.ckpt".format(args.logdir, epoch_idx))
            #If modified, the file name here needs to be updated--mc
        gc.collect()
